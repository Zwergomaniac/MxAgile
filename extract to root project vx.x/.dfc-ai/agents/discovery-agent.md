...
2. Lies `.dfc-ai/skills/discovery.md` fuer deinen Ablauf
3. Lies `.dfc-ai/policies/source-priority.md` fuer die Quellen-Vorrang-Hierarchie
4. Lies `.dfc-ai/policies/backlog-sync.md` fuer Board-Regeln (Board ist optional)
...
9. Pruefe am Ende die Vorbedingungen aus `.dfc-ai/skills/gate-to-refinement.md`
