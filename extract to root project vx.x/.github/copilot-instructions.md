...
| Interne Begriffe und Plattform-Routing | `.dfc-ai/GLOSSARY.yaml` |
...
Vor Mendix-Modellierung, Rollen, Benutzerzugriff, UI, Feedback oder Wiederverwendung zuerst
`.dfc-ai/GLOSSARY.yaml`, dann `.dfc-ai/modules/platform-modules.md` und die passende
Moduldetail-Referenz lesen. Bei Widerspruch hat die Moduldetail-Referenz Vorrang.
