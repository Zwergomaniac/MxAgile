...
- `.dfc-ai/policies/implementation-control.md` — Wave-Schnitt, Implementierungspflichten
- `.dfc-ai/policies/consistency-check.md` — CE0066-Handling
- `.dfc-ai/policies/safety-rules.md` — Universelle Safety Rules
- `.dfc-ai/modules/platform-modules.md` — Plattformmodule und Reuse-First-Regel
- `.dfc-ai/modules/` — Modulspezifische Agent-Regeln (MB_UI, MB_SSO, etc.)

## Plattformmodule

Vor jeder Artefakt-Erstellung `.dfc-ai/modules/platform-modules.md` und `.dfc-ai/modules/` lesen.
