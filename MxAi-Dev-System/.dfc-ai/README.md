# .dfc-ai/ — Agentenagnostisches Mendix Delivery System
...
Fachlogik** hier in `.dfc-ai/`. Ein Generierungsskript erzeugt daraus physische
Plattform-Kopien mit dem jeweils passenden Frontmatter.

```
.dfc-ai/ (neutral, template-owned)
    |
...
|---|---|---|---|
| **DFC-AI** (Prozess) | `.dfc-ai/` | Template | Template-Versionierung |
...
- `.dfc-ai/` ist **read-only aus dem Template**. Projektspezifische Regeln
...
| `scripts/generate-dfc-platform-skills.ps1` | `.dfc-ai/` → Plattform-Skills und -Agents |
...
`.concord/plans/dfc-ai-restructuring-plan.md`
