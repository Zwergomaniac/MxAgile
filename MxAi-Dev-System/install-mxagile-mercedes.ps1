<#
.SYNOPSIS
    Standalone MxAgile bootstrap installer with Mercedes-Benz Company Layer.
...
Usage examples:
  .\install-mxagile-mercedes.ps1 -DistributionSource "https://github.com/your-org/mxagile.git"
  .\install-mxagile-mercedes.ps1 -DistributionSource "C:\path\to\MxAi-Dev-System"
"@
        }
